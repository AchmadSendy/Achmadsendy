...
I'm a **Mechatronics Engineering** student at **Yogyakarta State University (UNY)**, passionate about **technology, programming, electronics, and IoT**. I actively build real-world web and automation projects for real clients.

I'm active as **Technical Lead at INFINITE UNY** (IT Division) and share tech & coding content on YouTube and TikTok.
...
![Freelance](https://img.shields.io/badge/Freelance-Web%20Dev%20%26%20IoT-8b5cf6?style=flat)
...
- **Auto Dough Pusher** – Industrial bakery automation machine *(STM32, Pneumatic)*
- **SendySkot Website** – Online tech learning platform *(WordPress, Elementor)*
